                                            ...
                                            <td>
                                                <div>
                                                    <input style="width: 30%; margin-left: 10px" 
                                                           ...
                                                           value="${p.inventory[0].stockQuantity}"
                                                           data-product-id="${p.id}"
                                                           onchange="changeItem(this)"
                                                    >
                                                </div>
                                            </td>
                                            <fmt:formatNumber value="${p.inventory[0].stockQuantity * p.price}" type="currency" currencyCode="VND" var="formattedPrice1" pattern="#,##0" />
                                            <td class="cart__price">${formattedPrice1}</td>
                                            <td class="cart__close"><i class="fas fa-times" onclick="removeProduct('${p.id}')"></i></td>
                                        </tr>
                                    </c:forEach>                                                                    
                                </tbody>
                            </table>      
